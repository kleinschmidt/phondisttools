...
user <- "kweatherholtz"
nsp_vows <- readRDS(paste0("/Users/", user, "/Dropbox/vowel-dist-learn/data/NSP_vowel_data_hVd_words.RDS"))
...
```{r covar2d}
# make a 2D variance-covariance matrix 
...
## Calculate KL divergence between bivariate Gaussians
```{r kl-divergence-for-multivariate-normals}
# function to calculate the KL divergence between two bivariate Gaussians
KL.bvnorm <- function(
