...
<!-- it's AN approach -->
The ideal adapter framework (Kleinschmidt & Jaeger, 2015, _Psych.Rev._) says that the best way to
...
```{r class-plots, fig.height = 3.3, fig.cap="Comprehension accuracy using different levels of grouping"}
...
<!-- We have shown that talker variability in vowels is _structured_, and that dialect is informative about variation in vowel distributions. -->
...
<!---For instance, gender, dialect, and other factors might influence consonant contrasts like /s/ vs. /\textesh/ in substantially different ways than vowels.-->
